    ...
    <form className="p-10 bg-white rounded shadow-xl">
      ...
      <div className="">
                ...
                <div className="inline-block mt-2 -mx-1 pl-1 w-1/2">
                    ...
                    <select  id="availability" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
                    {/* onChange={handleAvailabilityChange} value={formData.availability} */}
      ...
      <div className="mt-6">
        ...
        >
            button
          {/* {loading ? <div>Adding Don't Leave the Page<span className="text-2xl"> <LuLoader /></span></div> : <div className="flex justify-between"><span>Add Product</span> <span className="text-xl mt-2 ml-2"><MdOutlineAddShoppingCart /></span></div>} Show loading text while uploading */}
        </button>
      </div>
    </form>
  </div>

...
const fetchProducts = async () => {
  try {
    const response = await fetch("http://localhost:3000/api/products?category=baverages", { cache: 'no-store' }, {
      method: "GET"
    });
...
export default BaveragesCategory
...
const fetchProducts = async () => {
  try {
    const response = await fetch("http://localhost:3000/api/products?category=burgers", { cache: 'no-store' }, {
      method: "GET"
    });
...
const BurgerCategory = async () => {
  const products = await fetchProducts();
  return (
    <>
    <h1 className=' text-3xl mx-auto text-center font-semibold '>Burger Category</h1>

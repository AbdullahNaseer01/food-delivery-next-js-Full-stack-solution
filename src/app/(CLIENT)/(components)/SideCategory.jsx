...
const fetchProducts = async () => {
  try {
    const response = await fetch("http://localhost:3000/api/products?category=sides", { cache: 'no-store' }, {
      method: "GET"
    });
...
const SideCategory = async () => {
  ...
  return (
    <>
    <h1 className=' text-3xl mx-auto text-center font-semibold '>Side Category</h1>
